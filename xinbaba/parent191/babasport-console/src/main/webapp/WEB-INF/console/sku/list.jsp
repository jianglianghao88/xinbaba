...
<script type="text/javascript">
	function updateSku(skuId){
		$("input:enabled").attr("disabled",true);
	...
	<tbody class="pn-ltbody">
		<c:forEach items="${skus }" var="sku">
			...
			<tr bgcolor="#ffffff" onmouseover="this.bgColor='#eeeeee'" onmouseout="this.bgColor='#ffffff'">
				...
				<td align="center"><input type="text" id="m${sku.id }" value="${sku.marketPrice }" disabled="disabled" size="10" onchange="update('m'+${sku.id })"/></td>
				<td align="center"><input type="text" id="p${sku.id }" value="${sku.price }" disabled="disabled" size="10" onchange="update('p'+${sku.id })"/></td>
				<td align="center"><input type="text" id="i${sku.id }" value="${sku.stock }" disabled="disabled" size="10" onchange="update('i'+${sku.id })"/></td>
